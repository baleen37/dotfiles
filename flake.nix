{
  ...
  outputs =
    ...
    let
      ...
      testingInfrastructure = import ./lib/testing.nix { inherit inputs forAllSystems; };
      ...
      baseOutputs = {
        ...
        tests = testingInfrastructure.tests;

        # Performance benchmarks using modular performance system
        performance-benchmarks = testingInfrastructure.performance-benchmarks;
