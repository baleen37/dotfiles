...
in
{
    ...
    mkInterfaceTest =
      ...
      }:
      {
        ...
        testCase = {
          ...
          validator = exports: builtins.all (required: builtins.hasAttr required exports) requiredExports;
        };
      };
    ...
    mkPlatformContractTest =
      ...
      }:
      {
        ...
        testCase = {
          ...
          validator =
            platform:
            if builtins.elem platform platforms then
              testFunction platform
            else
  ...
  suite = {
    ...
    mkLayerSuite =
      ...
      then
        throw "Invalid test layer: ${layer}. Must be one of: unit, contract, integration, e2e"
      else
        {
  ...
  validators = {
    ...
    validateTestCase =
      ...
      if !hasRequiredFields then
        throw "Test case missing required fields: name, type, framework"
      else
        testCase;
    ...
    validateTestSuite =
      ...
      in
      if !hasRequiredFields then
        throw "Test suite missing required fields: name, type, testCases"
      else if !validTestCases then
        throw "Test suite contains invalid test cases"
      else
        suite;
