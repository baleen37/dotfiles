  ...
  monitoring = {
    ...
    reporting = {
      ...
      formatSummary = report: ''
        ...
        - **Status**: ${lib.strings.toUpper (report.monitoring.alerts.status or "unknown")}
        ...
        *Framework: ${report.metadata.framework or "unknown"} v${report.metadata.version or "0.0.0"}*
      '';
    };
