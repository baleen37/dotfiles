...
#
# Complete Tmux configuration in a single file (YAGNI principle)
#
# Features:
...
#       - Linux: xclip
#       - Universal: tmux internal buffer
#   - Session persistence:
...
#   - Mouse support: Scroll, pane resize
#
# Key bindings:
#   - Prefix: Ctrl+b
#   - Pane split: | (horizontal), - (vertical)
#   - Window create: Prefix+t
#   - Window navigation: Alt+h/l (no prefix needed)
