...
test_utilities_new() {
    ...
    [[ -n "$util_id" ]] || { echo "Error: util_id is required"; return 1; }
...
test_utilities_create_fixture() {
    ...
    [[ -n "$util_id" ]] || { echo "Error: util_id is required"; return 1; }
    [[ -n "$filename" ]] || { echo "Error: filename is required"; return 1; }
...
test_utilities_create_structure() {
    ...
    [[ -n "$util_id" ]] || { echo "Error: util_id is required"; return 1; }
    [[ -n "$structure_spec" ]] || { echo "Error: structure_spec is required"; return 1; }
...
test_utilities_random_string() {
    ...
    [[ -n "$util_id" ]] || { echo "Error: util_id is required"; return 1; }
    [[ "$length" =~ ^[0-9]+$ ]] || { echo "Error: length must be a number"; return 1; }
...
test_utilities_wait_for_condition() {
    ...
    [[ -n "$util_id" ]] || { echo "Error: util_id is required"; return 1; }
    [[ -n "$condition_command" ]] || { echo "Error: condition_command is required"; return 1; }
    [[ "$timeout_seconds" =~ ^[0-9]+$ ]] || { echo "Error: timeout_seconds must be a number"; return 1; }
    [[ "$check_interval" =~ ^[0-9]+$ ]] || { echo "Error: check_interval must be a number"; return 1; }
...
test_utilities_log() {
    ...
    [[ -n "$util_id" ]] || { echo "Error: util_id is required"; return 1; }
    [[ -n "$level" ]] || { echo "Error: level is required"; return 1; }
    [[ -n "$message" ]] || { echo "Error: message is required"; return 1; }
...
test_utilities_restore_file() {
    ...
    [[ -n "$util_id" ]] || { echo "Error: util_id is required"; return 1; }
    [[ -n "$backup_path" ]] || { echo "Error: backup_path is required"; return 1; }
    [[ -n "$original_path" ]] || { echo "Error: original_path is required"; return 1; }
    [[ -f "$backup_path" ]] || { echo "Error: backup_path '$backup_path' does not exist"; return 1; }
