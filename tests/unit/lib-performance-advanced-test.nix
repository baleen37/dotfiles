...
in
{
  ...
  time-measure-structure = helpers.assertTest "perf-time-measure-structure" (
    let
  ...
  time-measure-success = helpers.assertTest "perf-time-measure-success" (
    let
      result = perf.perf.time.measure (builtins.deepSeq 42 42);
    in
    result.success == true
  ...
  time-measure-value = helpers.assertTest "perf-time-measure-value" (
    let
  ...
  time-benchmark-structure = helpers.assertTest "perf-time-benchmark-structure" (
    let
  ...
  time-benchmark-iterations = helpers.assertTest "perf-time-benchmark-iterations" (
    let
  ...
  memory-monitor-structure = helpers.assertTest "perf-memory-monitor-structure" (
    let
  ...
  memory-monitor-delta = helpers.assertTest "perf-memory-monitor-delta" (
    let
  ...
  build-measure-eval-structure = helpers.assertTest "perf-build-measure-eval-structure" (
    let
  ...
  build-measure-derivation-structure = helpers.assertTest "perf-build-measure-derivation-structure" (
    let
      drv = pkgs.hello;
  ...
  build-measure-complexity-structure = helpers.assertTest "perf-build-measure-complexity-structure" (
    let
  ...
  build-measure-complexity-counts = helpers.assertTest "perf-build-measure-complexity-counts" (
    let
      config = { a = 1; b = 2; c = 3; };
      result = perf.build.measureConfigComplexity config;
    in
  ...
  build-measure-complexity-complexity = helpers.assertTest "perf-build-measure-complexity-complexity" (
    let
      config = { x = 1; };
      result = perf.build.measureConfigComplexity config;
    in
  ...
  resources-profile-structure = helpers.assertTest "perf-resources-profile-structure" (
    let
  ...
  resources-profile-cpu = helpers.assertTest "perf-resources-profile-cpu" (
    let
      result = perf.resources.profile (builtins.deepSeq 42 42);
    in
  ...
  resources-profile-metadata = helpers.assertTest "perf-resources-profile-metadata" (
    let
      result = perf.resources.profile (builtins.deepSeq 42 42);
    in
  ...
  resources-compare-structure = helpers.assertTest "perf-resources-compare-structure" (
    let
  ...
  resources-compare-ratios = helpers.assertTest "perf-resources-compare-ratios" (
    let
      result = perf.resources.compare
        (builtins.deepSeq 1 1)
        (builtins.deepSeq 2 2);
  ...
  testing-mk-perf-test-structure = helpers.assertTest "perf-testing-mk-perf-test-structure" (
    let
  ...
  testing-mk-perf-test-run = helpers.assertTest "perf-testing-mk-perf-test-run" (
    let
      test = perf.testing.mkPerfTest "test-op" (builtins.deepSeq 1 1) { };
      result = test.run;
    in
  ...
  testing-mk-benchmark-suite-structure = helpers.assertTest "perf-testing-mk-benchmark-suite-structure" (
    let
      tests = [
  ...
  testing-mk-benchmark-suite-summary = helpers.assertTest "perf-testing-mk-benchmark-suite-summary" (
    let
      tests = [
        (perf.testing.mkPerfTest "test1" (builtins.deepSeq 1 1) { })
      ];
  ...
  report-format-results-type = helpers.assertTest "perf-report-format-results-type" (
    let
      measurements = [
  ...
  report-format-results-content = helpers.assertTest "perf-report-format-results-content" (
    let
      measurements = [
        { duration_ms = 100; memoryAfter = 1000; success = true; }
      ];
