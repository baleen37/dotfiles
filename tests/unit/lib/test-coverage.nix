...
in runTests {
  ...
  testCalculateCoveredLinesNoTests = {
    ...
    in coverageSystem.measurement.calculateCoveredLines moduleInfo [];
    expected = 0;
  };
  ...
  testCalculateCoveredLinesWithTests = {
    ...
    in coverageSystem.measurement.calculateCoveredLines moduleInfo testResults;
  ...
  testGenerateConsoleReportBasic = {
    ...
    in builtins.isString (coverageSystem.reporting.generateConsoleReport session);
    expected = true;
  };
  ...
  testGenerateConsoleReportWithUncovered = {
    ...
    in builtins.isString report && lib.hasInfix "NOT MET" report;
    expected = true;
  };
  ...
  testGenerateHTMLReport = {
    ...
    in builtins.isString htmlReport && lib.hasInfix "<html>" htmlReport;
    expected = true;
  };
  ...
  testGenerateLCOVReport = {
    ...
    in builtins.isString lcovReport && lib.hasInfix "SF:" lcovReport;
    expected = true;
  };
  ...
  testGetCoverageStatusPass = {
    ...
    in coverageSystem.validation.getCoverageStatus session;
    expected = "PASS";
  };
  ...
  testGenerateGitHubActionsOutput = {
    ...
    in builtins.isString output && lib.hasInfix "coverage=92.3" output;
    expected = true;
  };
  ...
  testMergeSessionsMultiple = {
    ...
    in builtins.length merged.modules;
