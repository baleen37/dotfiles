...
in
{
  ...
  "${userHome}/.claude/CLAUDE.md" = {
    text = ''
      ...
      ## Workflow Guidelines
      When I make a request, separate the approach and execution phases. First, propose the approach and wait for my review before proceeding with implementation.
