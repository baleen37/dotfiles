...
#
# Extracted from home-manager.nix following dustinlyons pattern for single responsibility.
# This file contains all program-specific configurations that work across macOS and NixOS.
#
# ARCHITECTURE:
#   - Single responsibility: Only program configurations
#   - Cross-platform: Shared programs with platform-aware optimizations
#   - Performance optimized: Cached platform detection and optimized configurations
#
# USAGE:
#   Imported by modules/shared/home-manager.nix
#
# VERSION: 2.0.0 (Programs extracted)
