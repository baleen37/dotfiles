...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jiho Lee"
    user-mail-address "baleen37@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/baleen/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/baleen/bin" "/profile/bin" "/Users/baleen/.npm-packages/bin" "/Users/baleen/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
